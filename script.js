const ERAS_1 = [
  ...
  },
  {
    era: "PHASE 1 — SỰ TRỖI DẬY CỦA CÁC ANH HÙNG", desc: "Từng anh hùng xuất hiện riêng lẻ, dẫn đến cuộc quy tụ đầu tiên.", items: [
      ...
      { title: "Captain America: The Winter Soldier", year: "2012", phase: "Phase 1", type: "Phim", poster: "./img/captain_america_the_winter_soldier.webp", desc: "tiếp nối bộ phim The Avengers, khi Steve Rogers phải tìm cách hòa nhập vào thế giới hiện đại và kết hợp với Natasha Romanoff/Black Widow để chiến đấu chống lại một kẻ thù nguy hiểm ở Washington, D.C." },
    ]
  },
  {
  ...
  },
  {
    era: "PHASE 3 (CUỐI) — CUỘC CHIẾN VÔ CỰC", desc: "Thanos xuất hiện để hoàn thành sứ mệnh cân bằng vũ trụ.", items: [
      ...
      { title: "Ant-Man and the Wasp", year: "2018 (song song Infinity War)", phase: "Phase 3", type: "Phim", poster: "./img/ant_man_and_the_wasp.webp", desc: "Scott Lang cùng Hope van Dyne chạy đua giải cứu Janet từ Lượng Tử Giới, ngay trước cú búng tay." },
    ]
  },
  {
    era: "CÚ BÚNG TAY & ENDGAME", desc: "Năm năm sau thảm kịch, cái giá phải trả để đảo ngược tất cả.", items: [
...
const ERAS_2 = [
  {
    era: "HẬU BLIP — ĐA VŨ TRỤ BẮT ĐẦU HÉ MỞ", desc: "Thế giới hồi phục sau Blip. Đây cũng là lúc những nhánh phụ đầu tiên bắt đầu tỏa ra từ trục chính.", items: [
      ...
      { title: "Werewolf by Night", year: "2024", phase: "Phase 4", type: "Đặc biệt", poster: "./img/werewolf_by_night.webp", desc: "Một nhóm thợ săn quái vật tụ họp trong tang lễ bí ẩn của Bloodstone để tranh giành một di vật quyền năng." },
      ...
      { title: "Thor: Love and Thunder", year: "2024 - 2025", phase: "Phase 4", type: "Phim", poster: "./img/thor_love_and_thunder.webp", desc: "Thor tìm lại chính mình khi Gorr the God Butcher tiến hành cuộc thảm sát nhắm vào các vị thần khắp vũ trụ, trong lúc Jane Foster trở thành Mighty Thor." },
    ]
  },
  {
    era: "LOKI — ĐIỂM RẼ NHÁNH CHÍNH THỨC", desc: "Cái chết của He Who Remains phá vỡ Dòng Thời Gian Thiêng Liêng, chính thức khai sinh đa vũ trụ.", items: [
      {
        title: "Loki (Phần 1)", year: "2024 (mốc TVA)", phase: "Trục chính", type: "Series", poster: "./img/loki.webp",
  ...
  {
    era: "TRỤC CHÍNH TIẾP TỤC", desc: "Sau khi đa vũ trụ mở ra, trục chính vẫn chạy liên tục — song song đó là các nhánh phụ tiếp tục xuất hiện.", items: [
      { title: "Moon Knight", year: "2024", phase: "Trục chính", type: "Series", poster: "./img/moon_knight.webp", desc: "Steven Grant phát hiện mình chia sẻ cơ thể với lính đánh thuê Marc Spector, cả hai là avatar của thần Ai Cập Khonshu." },
      { title: "Ms. Marvel", year: "2024", phase: "Trục chính", type: "Series", poster: "./img/ms_marvel.webp", desc: "Kamala Khan, cô fangirl của Avengers, khám phá sức mạnh vũ trụ của chính mình gắn với chiếc vòng gia truyền." },
      ...
      {
        title: "She-Hulk: Attorney at Law", year: "2024", phase: "Trục chính", type: "Series", poster: "./img/she_hulk.webp",
        desc: "Jennifer Walters thừa hưởng sức mạnh Hulk qua truyền máu, cân bằng giữa sự nghiệp luật sư và đời siêu anh hùng.",
        twigs: [{ title: "Agatha All Along", year: "2024", type: "Series", poster: "./img/agatha_all_along.webp", desc: "Phù thủy Agatha Harkness, thoát khỏi lời nguyền của Wanda, dẫn nhóm phù thủy có 2 đứa con của Wanda đi qua Con Đường Phù Thủy nguy hiểm." }]
      },
      ...
      { title: "Loki (Phần 2)", year: "2025", phase: "Trục chính", type: "Series", poster: "./img/loki.webp", desc: "Loki chiến đấu để ổn định các nhánh thời gian đang rạn nứt, cố cứu lấy chính TVA khỏi sụp đổ." },
      { title: "Ant-Man and the Wasp: Quantumania", year: "2025", phase: "Trục chính", type: "Phim", poster: "./img/ant_man_and_the_wasp_quantumania.webp", desc: "Gia đình Scott Lang bị kéo vào Lượng Tử Giới và chạm trán Kang the Conqueror — kẻ chinh phục thời gian đầy tham vọng." },
      ...
      {
        title: "Black Panther: Wakanda Forever", year: "2025", phase: "Trục chính", type: "Series", poster: "./img/black_panther_wakanda_forever.webp",
        ...
        twigs: [{ title: "Deadpool & Wolverine", year: "2024", type: "Phim", poster: "./img/deadpool_and_wolverine.webp", desc: "Deadpool được chiêu mộ để ngăn vũ trụ của mình sụp đổ, hợp tác cùng một biến thể Wolverine giữa Khoảng Không đa vũ trụ." }]
      },
      ...
      { title: "VisionQuest", year: "Cuối 2026", phase: "Trục chính", type: "Series", poster: "./img/visionquest.webp", upcoming: true, desc: "Vision, sau khi được tái tạo từ sự kiện WandaVision, lên đường đi tìm lại bản dạng thật sự của chính mình." },
    ]
  },
];
